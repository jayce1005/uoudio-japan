...
export const products: Product[] = [
  ...
  },
  {
    ...
    gallery: [
      { src: "/s21-sound.jpg", alt: "S16 20W大音量サウンド" },
      { src: "/s21-dsp.jpg", alt: "S16 DSPサウンド処理" },
      { src: "/s21-battery.jpg", alt: "S16 最大24時間連続再生" },
      { src: "/s21-display.jpg", alt: "S16 音量とバッテリー残量のデジタル表示" },
      { src: "/s21-eq.jpg", alt: "S16 2種類のEQモードとRGBライト" },
      { src: "/s21-tws.jpg", alt: "S16 2台接続TWSステレオ" },
      { src: "/s21-waterproof.jpg", alt: "S16 IPX6防水仕様" },
      { src: "/s21-portable.jpg", alt: "S16 吊り下げストラップ付きポータブル設計" },
    ],
  },
  {
  ...
  },
  {
    ...
    amazonUrl: "https://www.amazon.co.jp/dp/B0G4CS58WN?th=1",
    price: 3699,
    specs: [
      { label: "定格出力", value: "20W" },
      { label: "ドライバー", value: "52mmデュアルドライバー" },
      { label: "音質処理", value: "DSPデジタル音声処理" },
      { label: "Bluetooth", value: "Bluetooth 5.4" },
      { label: "ステレオ", value: "TWS対応・2台で最大40W", note: "同一モデルが2台必要です" },
      { label: "連続再生", value: "最大24時間", note: "音量・RGBライト・再生内容・使用環境により異なります" },
      { label: "防水性能", value: "IPX7", note: "水中での常用や濡れた状態での充電は避けてください" },
      { label: "ライト", value: "6色RGB / 消灯可能" },
      { label: "再生方法", value: "Bluetooth / 3.5mm AUX / microSD" },
      { label: "microSD", value: "最大32GB・MP3形式" },
      { label: "充電", value: "USB Type-C・5V / 1A" },
      { label: "通話", value: "ハンズフリー通話対応" },
      { label: "重量", value: "約345g" },
      { label: "携帯性", value: "ストラップ付き" },
    ],
    features: [
      { title: "IPX7防水・約345gの軽量設計", text: "雨や水しぶきが気になる場所でも使いやすいIPX7防水仕様。約345gのコンパクトボディとストラップで、自宅からキャンプまで気軽に持ち出せます。" },
      { title: "20W出力・DSP・デュアルドライバー", text: "52mmドライバー2基とDSP音声処理で、クリアな中高音と厚みのある低音を両立。音楽、映画、動画をバランスのよい音で楽しめます。" },
      { title: "TWSステレオ・2台で最大40W", text: "同じS20を2台接続すると、左右に広がるステレオ再生が可能。映画鑑賞、キャンプ、パーティーなどで、より臨場感のある音を届けます。" },
      { title: "6色RGB・ライトOFF対応", text: "リズム連動、点滅、固定色に対応する6色RGBライトを搭載。シーンに合わせて切り替えられ、光が不要なときは消灯できます。" },
      { title: "最大24時間・Bluetooth 5.4", text: "最大24時間再生とType-C充電に対応。Bluetooth 5.4、microSD、3.5mm AUXを選べ、内蔵マイクでハンズフリー通話もできます。" },
    ],
    banner: "/s20-banner.png",
    gallery: [
      { src: "/s20-waterproof.jpg", alt: "S20 IPX7防水仕様" },
      { src: "/s20-portable.jpg", alt: "S20 約345gの軽量設計とストラップ" },
      { src: "/s20-sound.jpg", alt: "S20 20Wサウンドと52mmデュアルドライバー" },
      { src: "/s20-dsp.jpg", alt: "S20 DSPデジタル音声処理" },
      { src: "/s20-battery.jpg", alt: "S20 最大24時間連続再生" },
      { src: "/s20-inputs.jpg", alt: "S20 microSD AUX Type-C対応端子" },
      { src: "/s20-rgb.jpg", alt: "S20 6色RGBライト" },
    ],
  },
  {
  ...
  },
  {
    ...
    gallery: [
      { src: "/gb-mini-sound.jpg", alt: "GB 01 10Wフルレンジドライバーと内部構造" },
      { src: "/gb-mini-dsp.jpg", alt: "GB 01 DSPデジタル音声処理" },
      { src: "/gb-mini-tws.jpg", alt: "GB 01 2台接続TWSステレオ" },
      { src: "/gb-mini-lights.jpg", alt: "GB 01 3種類のライトモード" },
      { src: "/gb-mini-battery.jpg", alt: "GB 01 最大12時間連続再生" },
      { src: "/gb-mini-waterproof.jpg", alt: "GB 01 IPX6防水" },
      { src: "/gb-mini-inputs.jpg", alt: "GB 01 AUX TFカード USB Type-C対応" },
      { src: "/gb-mini-sos.jpg", alt: "GB 01 SOS赤色点滅ライト" },
    ],
  },
];
